...
enum class BuzzType(val pattern: LongArray) {
    CORRECT(correctBuzzPattern),
    GAME_OVER(gameOverBuzzPattern),
    COUNTDOWN_PANIC(panicBuzzPattern),
    NO_BUZZ(noBuzzPattern)
}

private val correctBuzzPattern = longArrayOf(100, 100, 100, 100, 100, 100)
private val panicBuzzPattern = longArrayOf(0, 200)
private val gameOverBuzzPattern = longArrayOf(0, 2000)
private val noBuzzPattern = longArrayOf(0)